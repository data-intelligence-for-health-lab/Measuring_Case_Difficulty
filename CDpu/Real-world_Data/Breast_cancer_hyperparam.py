...
log_file_name = './app3_breast_cancer_hyperparam.log'
file_name = './app3_breast_cancer_hyperparam.xlsx'
...
def objective(config):
    ...
    model.add(Dense(config['hidden_layer_sizes'][0], input_shape=(X_train_scaled.shape[1],), activation=config['activation']))   
